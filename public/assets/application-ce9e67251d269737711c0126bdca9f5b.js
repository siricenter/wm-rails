...
(function() {
  $(document).ready(function() {
    return $('#building').on('change', function() {
...
(function() {
  var available, checkAvailability, unavailable;

  checkAvailability = function(building) {
    var building_id, semesterId;
    ...
    return $.get("/buildings/" + building_id + "/availability/" + semesterId, {}, function(data) {
      if (data.available) {
        return available();
      } else {
        return unavailable();
  ...
  $(document).ready(function() {
    $('#mens').on('click', function() {
      return checkAvailability('mens');
    });
    return $('#womens').on('click', function() {
      return checkAvailability('womens');
    });
  });

  available = function(data) {
    $('#available-answer').addClass('success').hide().fadeIn();
    return $('#available-answer').children().first().text('Available: Book Now!');
  };
