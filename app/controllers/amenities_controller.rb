class AmenitiesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if Cloudinary::PreloadedFile.new(params[:img_id]).present?
        preloaded = Cloudinary::PreloadedFile.new(params[:img_id])
        @amenity.img_id = preloaded.identifier
      end
      if @amenity.save
  ...
  private
    ...
    def amenity_params
      params.require(:amenity).permit(:title, :img_id, :img_desc)
    end
end
